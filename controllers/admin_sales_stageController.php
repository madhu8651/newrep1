...
$GLOBALS['$log'] = Logger::getLogger('admin_sales_stageController');

class admin_sales_stageController extends Master_Controller{
    public function __construct(){
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('admin_sales_stageModel','sales_stage');
    }
    public function index(){
        if($this->session->userdata('uid')){
         $this->load->view('admin_sales_stage_view');
        }else{
