...
$GLOBALS['$log'] = Logger::getLogger('admin_lconnectt_mail_setting_controller');

class admin_lconnectt_mail_setting_controller extends Master_Controller{
	public function __construct(){
		parent::__construct();
        $this->load->helper('url');
        $this->load->model('admin_lconnectt_mail_setting_Model','mailsetting');
	}

    public function index(){

        if($this->session->userdata('uid')){
           $this->load->view('admin_lconnectt_mail_setting');
        }else{
        ...
        if($this->session->userdata('uid')){
            try{
                    ...
                    $data2=array(
                        ...
                        'timestamp'=>$dt,
						'email_settings_type'=>'emailsetting'
