...
$GLOBALS['$log'] = Logger::getLogger('admin_mastersales_stageController');

class admin_mastersales_stageController extends Master_Controller{
    public function __construct(){
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        //$this->output->enable_profiler(true);
        $this->load->model('admin_mastersales_stageModel','mastersales_stage');
    }
    public function index(){
        if($this->session->userdata('uid')){
         $this->load->view('admin_mastersales_stage_view');
        }else{
