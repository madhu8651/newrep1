...
$GLOBALS['$log'] = Logger::getLogger('admin_sales_cycleController');

class admin_sales_cycleController extends Master_Controller{
    public function __construct(){
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('admin_sales_cycleModel','cycle');
    }
    public function index(){
        if($this->session->userdata('uid')){
           $this->load->view('admin_sales_cycle_view');
        }else{
