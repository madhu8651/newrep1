...
$GLOBALS['$log'] = Logger::getLogger('admin_sup_mastersales_cycleController');

class admin_sup_mastersales_cycleController extends Master_Controller{
    public function __construct(){
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('admin_sup_mastersales_cycleModel','mastercycle');
    }
    public function index(){
        if($this->session->userdata('uid')){
           $this->load->view('admin_sup_mastersales_cycle_view');
        }else{
