...
<script>
	...
	function assign_save() {	
		...
		if (finalArray['users'].length == 0) {
			...
			return;
		}else if (finalArray['leads'].length == 0)	{
			...
			$.ajax({
					...
					success: function(data) {
						...
						for(i=0; i < data.length; i++ ){ 
							...
							var ms = cal_duration;
							let duration = moment.utc(ms).format("HH:mm:ss");						
							console.log(duration); 
							$('#logtable').empty();
							var rowdata = JSON.stringify(data[i]);	
							if(data[i].rating == 1){
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].meeting_start +"</td><td>" + data[i].type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i>" +"</td><td>" + data[i].duration +"</td><td>" + data[i].action +"</td><td>"+ data[i].note +"</td>";
							}else if(data[i].rating == 2){
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].meeting_start +"</td><td>" + data[i].type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i>" +"</td><td>" + data[i].duration +"</td><td>" + data[i].action +"</td><td>"+ data[i].note +"</td>";
							}else if(data[i].rating == 3){
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].Start_time +"</td><td>" + data[i].type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' ></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i>" +"</td><td>" + data[i].duration +"</td><td>"+ data[i].action +"</td><td>" + data[i].note +"</td>";
							}else if(data[i].rating == 4){
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].Start_time +"</td><td>" + data[i].type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' ></i>" +"</td><td>" + duration +"</td><td>"+ data[i].action +"</td><td>" + data[i].note +"</td>";
							}else {
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].time_stamp +"</td><td>" + "-" + "</td><td>" + "<i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i>" +"</td><td>" + "-" +"</td><td>" + data[i].action +"</td><td>" + "-" +"</td>";
							}
					}   
					$('#logtable').append(row);  
					}
			...
			$.ajax({
					...
					success: function(data) {
						...
						for(i=0; i < data.length; i++ ){  
							...
							console.log(now);
							var then = data[i].end;
							duration=moment(moment(now,"DD/MM/YYYY HH:mm:ss").diff(moment(then,"DD/MM/YYYY HH:mm:ss"))).format("HH:mm:ss");
							console.log(duration);
							$('#logtable1').empty();
							var rowdata = JSON.stringify(data[i]);	
							if(data[i].rating == 1){
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].meeting_start +"</td><td>" + data[i].call_type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i>" +"</td><td>" + duration +"</td><td>" + data[i].note +"</td>";
							}else if(data[i].rating == 2){
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].meeting_start +"</td><td>" + data[i].call_type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i>" +"</td><td>" + duration +"</td><td>" + data[i].note +"</td>";
							}else if(data[i].rating == 3){
								row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].Start_time +"</td><td>" + data[i].call_type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' ></i><i class='fa fa-star' aria-hidden='true' style='color:lightgray'></i>" +"</td><td>" + duration +"</td><td>" + data[i].note +"</td>";
							}else if(data[i].rating == 4){
									row += "<tr><td>" + (i+1) + "</td><td>" + data[i].leadname +"</td><td>" + data[i].Start_time +"</td><td>" + data[i].call_type + "</td><td id='ff'>" + "<i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true'></i><i class='fa fa-star' aria-hidden='true' ></i>" +"</td><td>" + duration +"</td><td>" + data[i].note +"</td>";
							}else {
									row += "<tr><td>" + (i+1) + "</td><td>" + data[i].user_name +"</td><td>" + data[i].meeting_start +"</td><td>" + data[i].meeting_end +"</td><td>" + data[i].activity +"</td><td>" + data[i].activity +"</td><td>"+data[i].remarks +"</td>";
							}
						}     
                        ...
                        <form id="viewpopup" class="form" action="#" method="post" >
                            ...
                            <div class="modal-body">								
                               ...
                               <div class="row" >
								...
								<div class="row btn_log">
									<center>
										<button type="button" class="btn" id="opp_log" onclick="oppo_fetch();" >View opp Activity</button>		
									</center>
                                </div>


								<div class="row" id="opp_details1">
                                    <div class="col-md-12 lead_view">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <center><b>Opportunity Details</b></center>
                                        </div>
                                    </div>
                                        <table class="table" id="opp_log1">
                                        	<thead>  
                                            	<tr>	
													<th class="table_header">#</th>
													<th class="table_header">rep_name</th>
							 	  ...
							 	  <!-- <div class="row" id="opportunity">
										<div class="row btn_log">
											<center>
												<button type="button" class="btn" id="opp_log" onclick="oppo_fetch()" >View Opportunities</button>
											</center>
										</div>
								</div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
								...
								<!-- <input type="checkbox" name="select_all_mgr" onclick="checkAllMgrs(this)">  -->                         	
                               <!--  <div class="row targetrow ">
