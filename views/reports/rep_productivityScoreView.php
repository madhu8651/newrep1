    ...
    <head>
		...
		<script type="text/javascript">
			...
			function generateReport(){
				...
				obj.resource_name = $("#resource_name").val();
				...
				<div class="page-container">
					<div class="row report_input_data" >
						...
						<div class="col-md-2">
							...
							<select class="form-control" id="team" onchange="list_view('off_location')">
							</select>
							<span class="error-alert"></span>
						</div>
                        <div class="col-md-2">
							<label for="off_location">Location</label>
							<select class="form-control" id="off_location" onchange="list_view('resource_name')">
							</select>
							<span class="error-alert"></span>
						</div>
                        <div class="col-md-2">
							<label for="resource_name">Resource Name</label>
							<select class="form-control" id="resource_name">
							</select>
							<span class="error-alert"></span>
						</div>
							<div class="col-md-3">
