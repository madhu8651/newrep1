...
<html lang="en">
    ...
    function loadpage(){
        ...
        $.ajax({
			type : "POST",
			url : "<?php echo site_url('admin_mastersales_cycleController/get_cycle'); ?>",
			dataType : 'json',
			cache : false,
		...
		function add(){
			if($.trim($("#add_salescycle").val())==""){
				$("#add_salescycle").closest("div").find("span").text("Master Cycle Name is required.");
			...
			$.ajax({
				type : "POST",
				url : "<?php echo site_url('admin_mastersales_cycleController/post_data'); ?>",
				dataType : 'json',
		...
		function edit_save(){
				if($("#edit_salescycle").val()==""){
					$("#edit_salescycle").closest("div").find("span").text("Master Cycle Name is required.");
				...
				$.ajax({
					type : "POST",
					url : "<?php echo site_url('admin_mastersales_cycleController/update_data'); ?>",
					dataType : 'json',
					data : JSON.stringify(addObj),
					cache : false,
					success : function(data){
				...
				<table class="table" id="tableTeam">
					<thead>
						<tr>
							...
							<th class="table_header" width="60%">Master Sales Cycle</th>
					...
					<div class="modal-content">
						<form id="editpopup" class="form" action="#" method="post" name="adminClient">
							<div class="modal-header">
								 ...
								 <h4 class="modal-title">Edit Master Cycle</h4>
							</div>
							<div class="modal-body">

									<div class="row">
										<div class="col-md-3">
											<label for="edit_loc">Master Cycle*</label>
										</div>
										<div class="col-md-9">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<form id="addpopup" class="form" action="#" method="post" name="adminClient">
							<div class="modal-header">
								 <span class="close" onclick="cancel()">x</span>
								 <h4 class="modal-title">Add Master Cycle</h4>
							</div>
							<div class="modal-body">

									<div class="row">
										<div class="col-md-3">
											<label for="add_region1">Master Cycle*</label>
										</div>
										<div class="col-md-9">
