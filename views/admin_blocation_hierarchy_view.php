...
<script>
    ...
    function loadpage(){
        loaderShow();
      	$.ajax({
      		type : "post",
      		url : "<?php echo site_url('admin_blocation_hierarchyController/get_lead_source');?>",
      		dataType : "json",
      		cache : false,
	...
	function edit_save(){
		...
		if($.trim($("#edit_lead").val())==""){
			$("#edit_lead").closest("div").find("span").text("Business Location is required.");
			$("#edit_lead").focus();
            loaderHide();
			return;
		...
		$.ajax({
			type : "POST",
			url : "<?php echo site_url('admin_blocation_hierarchyController/update_source')?>",
			...
			success : function(data){
                ...
                if(data=='0'){
                    $("#alert").modal("show");
					$("#alert center span").text("Business Location Already Defined");
					return;
                }else{
					cancel();
                    testData = [];
	...
	function add_source(){
		...
		if($.trim($("#add_lead_sub").val())==""){
			$("#add_lead_sub").closest("div").find("span").text("Business Location is required.");
			$("#add_lead_sub").focus();
            loaderHide();
			return;
		...
		$.ajax({
			type : "POST",
			url : "<?php echo site_url('admin_blocation_hierarchyController/post_lead_data')?>",
				...
				<div class="row header1">				
					<div class="col-xs-2 col-sm-2 col-md-4 col-lg-4 aa">
						<span class="info-icon">
							<div >		
								<img src="<?php echo base_url(); ?>images/new/i_off.png" onmouseover="this.src='<?php echo base_url(); ?>images/new/i_ON.png'" onmouseout="this.src='<?php echo base_url(); ?>images/new/i_off.png'" alt="info" width="30" height="30"  data-toggle="tooltip" data-placement="right" title="Business Location"/>
							</div>
						</span>
						<div class="style_video">
							<span class="glyphicon glyphicon-facetime-video " onclick="select_video('Business_Location', 'video_body', 'Admin')" data-toggle="tooltip" data-placement="right" title="Click to play info video"></span>
						</div>
					</div>
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-6 col-lg-4">
										<label for="edit_parent">Business Location</label> 
									</div>
								...
								<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-6 col-lg-4">
										<label for="edit_lead">Business Location Name</label>
									</div>
									<div class="col-md-8 col-sm-8 col-xs-6 col-lg-8">
					...
					<div class="modal-content">
						<form id="addpopup" class="form" action="#" method="post" name="adminClient">
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-6 col-lg-4">
										<label for="add_sub">Business Location</label> 
									</div>
									<div class="col-md-8 col-sm-8 col-xs-6 col-lg-8">
								...
								<div class="row">
									<div class="col-md-4 col-sm-4 col-xs-6 col-lg-4">
										<label for="add_lead_sub">Business Location Name</label>
									</div>
									<div class="col-md-8 col-sm-8 col-xs-6 col-lg-8">
