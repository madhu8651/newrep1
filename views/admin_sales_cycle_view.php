...
.dash-left{
    ...
    function loadpage(){
        ...
        $.ajax({
			type : "POST",
			url : "<?php echo site_url('admin_sales_cycleController/get_cycle'); ?>",
			dataType : 'json',
			cache : false,
...
function resetbit(){
  ...
  $.ajax({
        type : "POST",
        url : "<?php echo site_url('admin_sales_cycleController/resetbit'); ?>",
        dataType : 'json',
        cache : false,
        success : function(data){
            if(error_handler(data)){
...
function toggle(id,cycle_id,obj){
  if($("#"+id).prop('checked')==true){
                        ...
                        if(parseInt(activecnt)==2 && versiontype=='lite'){
                              ...
                              $.ajax({
                      			type : "POST",
                      			url : "<?php echo site_url('admin_sales_cycleController/check_activecycle'); ?>",
                      			dataType : 'json',
    	...
    	$(".Ok").click(function(){
            ...
            $.ajax({
    			type : "POST",
    			url : "<?php echo site_url('admin_sales_cycleController/update_tg_bit'); ?>",
    			dataType : 'json',
    			data : JSON.stringify(addObj),
    			cache : false,
    			success : function(data){
...
function updatebit1(cycle_id){
		...
		function compose(){
			...
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('admin_sales_cycleController/get_mastercycle'); ?>",
				dataType:'json',
				success: function(data) {
					if(error_handler(data)){
						return;
		...
		function add(){
			...
			if($.trim($("#add_salescycle").val())==""){
				$("#add_salescycle").closest("div").find("span").text("Sales Cycle is required.");
            ...
            if($.trim($("#add_mastercycle").val())==""){
				$("#add_mastercycle").closest("div").find("span").text("Master Cycle is required.");
			...
			var addObj={};
				...
				$.ajax({
					type : "POST",
					url : "<?php echo site_url('admin_sales_cycleController/post_data'); ?>",
					dataType : 'json',
					data : JSON.stringify(addObj),
					cache : false,
					success : function(data){
		...
		function edit_save(){
				...
				if($("#edit_salescycle").val()==""){
					$("#edit_salescycle").closest("div").find("span").text("Sales Cycle is required.");
                ...
                if($.trim($("#edit_mastercycle").val())==""){
					$("#edit_mastercycle").closest("div").find("span").text("Master Cycle is required.");
				...
				$.ajax({
					type : "POST",
					url : "<?php echo site_url('admin_sales_cycleController/update_data'); ?>",
					dataType : 'json',
					data : JSON.stringify(addObj),
					cache : false,
					success : function(data){
				...
				<table class="table" id="tableTeam">
					<thead>
						<tr>
							...
							<th class="table_header">Sales Cycle</th>
							<th class="table_header">Master Cycle</th>
					...
					<div class="modal-content">
						<form id="editpopup" class="form" action="#" method="post" name="adminClient">
							<div class="modal-header">
								 ...
								 <h4 class="modal-title">Edit Sales Cycle</h4>
							</div>
							<div class="modal-body">

									<div class="row">
										<div class="col-md-3">
											<label for="edit_loc">Sales Cycle*</label>
										</div>
										<div class="col-md-9">
                                    ...
                                    <div class="row">
										<div class="col-md-3">
											<label for="edit_region">Master Cycle *</label>
										</div>
										<div class="col-md-9">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<form id="addpopup" class="form" action="#" method="post" name="adminClient">
							<div class="modal-header">
								 <span class="close" onclick="cancel()">x</span>
								 <h4 class="modal-title">Add Sales Cycle</h4>
							</div>
							<div class="modal-body">

									<div class="row">
										<div class="col-md-3">
											<label for="add_region1">Sales Cycle*</label>
										</div>
										<div class="col-md-9">
                                    ...
                                    <div class="row">
										<div class="col-md-3">
											<label for="add_region">Master Cycle *</label>
										</div>
										<div class="col-md-9">
