...
function assignedLoad(){
	...
	$.ajax({
		type: "POST",
		url: "<?php echo site_url('sales_customerController/myCustomerDetails');?>",
		dataType:'json',
...
/* function addProductPurchase(){
	...
	if($.trim($("#product_Currency").val())==""){
		...
		if($.trim($("#pro_Value").val())==""){
			$("#pro_Value").closest("div").find("span").text("Product is required.");
			$("#pro_Value").focus();				
			return;
		}else{
			$("#pro_Value").closest("div").find("span").text("");
		}
		if($.trim($("#product_Number").val())==""){
			$("#product_Number").closest("div").find("span").text("Quantity is required.");
			$("#product_Number").focus();				
			return;
		}else{
			$("#product_Number").closest("div").find("span").text("");
		}	
		if($.trim($("#product_start_date").val())==""){
			$("#product_start_date").closest("div").find("span").text("Start date is required.");
			$("#product_start_date").focus();				
			return;
		}else{
			$("#product_start_date").closest("div").find("span").text("");
		}
		if($.trim($("#product_end_date").val())==""){
			$("#product_end_date").closest("div").find("span").text("End date is required.");
			$("#product_end_date").focus();				
			return;
		}else{
			$("#product_end_date").closest("div").find("span").text("");
		}			
    ...
    var addObj={};
    addObj.product = prod;
    addObj.product_Number= $.trim($("#product_Number").val());
    addObj.pro_Value=$.trim($("#pro_Value").val());
    addObj.pro_owner=$.trim($("#pro_owner").val());
    addObj.product_start_date=$.trim($("#product_start_date").val());
    addObj.product_end_date=$.trim($("#product_end_date").val());
    addObj.customer_id=$("#customer_id").val();
    console.log(addObj);
         $.ajax({
        type : "POST",
        ...
        console.log(data); 
        $(".prod_purchase_info").html("");
        for (var i = 0;i<data.length; i++) {
        	$(".prod_purchase_info").append('<div class="row"><div class="col-xs-2 apport_label"><label>Product</label></div><div class="col-xs-4"><label>'+data[i].product_id+'</label></div><div class="col-xs-2 apport_label"><label>Account Owner</label></div><div class="col-xs-4"><label>'+data[i].purchase_id+'</label></div></div><div class="row"><div class="col-xs-2 apport_label"><label>Start Date</label></div><div class="col-xs-4"><label>'+data[i].purchase_start_date+'</label><span class="error-alert"></span></div><div class="col-xs-2 apport_label"><label>End Date</label></div><div class="col-xs-4"><label>'+data[i].purchase_end_date+'</label></div></div><hr>'); 	
        } 
	...
	<div class="loader">
        ...
        <div class="content-wrapper body-content">
			...
			<div id="lead_hist" class="modal fade" data-backdrop="static" data-keyboard="false">
			  ...
			  <div id="modalpurchase" class="modal fade" data-backdrop="static">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form id="addpopup" class="form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <input type="" class="form-control" id="product_Number" name="product_Number"> 
                                        <span class="error-alert"></span>
                                    </div>
									<div class="col-xs-2">
                                    ...
                                    <div class="col-xs-4">
                                        <input class="form-control" id="product_start_date" placeholder="DD-MM-YYYY"/>
                                        <span class="error-alert"></span>
                                    </div>
                                 </div>
								<div class="row">
                                    ...
                                    <div class="col-xs-4">
                                        <input class="form-control" id="product_end_date" placeholder="DD-MM-YYYY" />
                                    </div>
								</div>
							</div>
							<div class="modal-footer">
