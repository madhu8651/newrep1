	...
	<head>
		...
		<script type="text/javascript">
            ...
            function load(){
                  $.ajax({
						type : "post",
						url : "<?php echo site_url('admin_lconnectt_mail_setting_controller/get_details'); ?>",
						dataType : "json",
                        cache : false,
			...
			function validatefield(){
				...
				/* ------------------------------Login Setting----------------------------------------- */
					...
					loaderShow();
					 $.ajax({
						type : "post",
						url : "<?php echo site_url('admin_lconnectt_mail_setting_controller/validate_email'); ?>",
            ...
            function saveemail_details(){
                ...
                $.ajax({
						type : "post",
						url : "<?php echo site_url('admin_lconnectt_mail_setting_controller/save_email'); ?>",
					...
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 aa">
						<span class="info-icon">
							<div data-toggle="tooltip" title="Hooray!" >
								<img src="<?php echo base_url()?>images/new/i_off.png" onmouseover="this.src='<?php echo base_url()?>images/new/i_ON.png'" onmouseout="this.src='<?php echo base_url()?>images/new/i_off.png'" alt="info" width="30" height="30" data-toggle="tooltip" data-placement="right" title="Admin Mail Settings"/>
							</div>
						</span>
					</div>
