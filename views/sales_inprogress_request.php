...
function loaddata(){
    $('#tablebody').parent("table").dataTable().fnDestroy();
      $.ajax({
            type: "POST",
            url: "<?php echo site_url('sales_supportController/inprogress_ticketDetails'); ?>",
            dataType:'json',
...
function close_request(){
 ...
 var close_sec= '<div class="modal-header">'+
                ...
                '<div class="modal-footer">'+
                    ...
                    '<button class="btn btn-default" onclick="close_save(\''+request_id+'\')">Submit</button>'+
                '</div>';
                ...
                <div id="view_request" class="modal fade" data-backdrop="static">
                    <div class="modal-dialog ">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button  type="button" class="btn btn-default" id="reassign" onclick="close_request()" >Close Request</button>
