...
function loaddata(){
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('leadinfo_controller/display_closed'); ?>",
        dataType:'json',
				...
				<div class="row header1">				
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 aa">
						<span class="info-icon">
							<div >		
								<img src="/images/new/i_off.png" onmouseover="this.src='/images/new/i_ON.png'" onmouseout="this.src='/images/new/i_off.png'" alt="info" width="30" height="30"  data-toggle="tooltip" data-placement="bottom" title="View all the leads that have been successfully converted into customers."/>
							</div>
						</span>
					</div>
